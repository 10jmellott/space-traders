 ...
 */
export function instanceOfCreateShipSystemScan201ResponseData(value: object): boolean {
	let isInstance = true;
...
export function CreateShipSystemScan201ResponseDataToJSON(value?: CreateShipSystemScan201ResponseData | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
