 ...
 */
export function instanceOfContractDeliverGood(value: object): boolean {
	let isInstance = true;
	isInstance = isInstance && "tradeSymbol" in value;
	isInstance = isInstance && "destinationSymbol" in value;
	isInstance = isInstance && "unitsRequired" in value;
	isInstance = isInstance && "unitsFulfilled" in value;
