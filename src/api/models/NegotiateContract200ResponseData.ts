 ...
 */
export function instanceOfNegotiateContract200ResponseData(value: object): boolean {
	let isInstance = true;
...
export function NegotiateContract200ResponseDataToJSON(value?: NegotiateContract200ResponseData | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
